...
if __name__ == "__main__":
    ...
    parser.add_argument("--image_folder", type=str, default="data/0520_test/416/2/", help="path to dataset")
    parser.add_argument("--output_folder", type=str, default="data/0520_test/416/2_output/", help="path to detection results")
    parser.add_argument("--model_def", type=str, default="config/yolov3-voc.cfg", help="path to model definition file")
    parser.add_argument("--weights_path", type=str, default="weights/yolov3-voc_0429.pth", help="path to weights file")
    ...
    for img_i, (path, detections) in enumerate(zip(imgs, img_detections)):
        ...
        out_file=opt.output_folder+filename+".png"
